...
public class KalmanFilter2 {
	...
	Matrix Q_estimate;  //estimate of initial location estimation of where the hexbug is (what we are updating)

	private Matrix P;	// Convariance estimation
	...
	private ArrayList<Matrix> Q_loc_estimate;

	private ArrayList<Matrix> vel_estimate;

	private Matrix P_estimate;

	private ArrayList<Double> predic_state;

	private ArrayList<Matrix> predic_var;
	...
	private ArrayList<Matrix> Q_loc_meas;
	
//	private ArrayList<Long> current_time;
	
	public KalmanFilter2(double u, double HexAccel_noise_mag, double tkn_x, double tkn_y, ArrayList<PhoneData> phonedata){
...
//		this.tkn_y = tkn_y;
		...
		Q_loc_estimate = new ArrayList<Matrix>();
		vel_estimate = new ArrayList<Matrix>();
		
//		P_estimate = P;
		
		predic_state = new ArrayList<Double>();
		predic_var = new ArrayList<Matrix>();
		...
		Q_loc_meas = new ArrayList<Matrix>();
		
		
		for(int i = 0; i<phonedata.size(); i++){
			Q_loc_meas.add[i][0][0] = phonedata.get(i).x;
